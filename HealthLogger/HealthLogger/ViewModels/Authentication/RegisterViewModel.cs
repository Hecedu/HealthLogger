...
namespace HealthLogger.ViewModels
{
    class RegisterViewModel : BaseViewModel
    {
        ...
        public RegisterViewModel(INavService navService, IDataStore<MealLog, ActivityLog> dataStore, IAuthenticationService authenticationService, IAlertService alertService) 
